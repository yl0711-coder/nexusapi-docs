...
Some clients automatically append `/v1` or a request path. Follow the dedicated guide for [Claude Code](/en/tools/claude-code), [Codex CLI](/en/tools/codex-cli), [CC Switch](/en/tools/cc-switch), or [VS Code / Cursor](/en/tools/cursor-vscode) instead of copying this URL mechanically.
</Tip>
