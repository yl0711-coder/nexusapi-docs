...
| `500, not implemented` | Kiểm tra xem `supported_endpoint_types` của model có chứa giao thức đang dùng trong yêu cầu hay không. |
...
Hãy gửi các thông tin sau trong cùng một tin nhắn:
