...
`temperature`、ツール呼び出し、画像入力、構造化出力などのオプションは、「OpenAI 互換」だけで全モデルに保証されるものではありません。モデル/チャネルの可用性は[API とモデル対応マトリクス](/ja/developer/capability-matrix)とモデルマーケットプレイスで確認してください。
